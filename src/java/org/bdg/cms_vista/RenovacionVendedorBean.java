 ...
 */
@ManagedBean(name = "renovacionVendedorBean")
@ViewScoped
public class RenovacionVendedorBean extends BaseSession {
    ...
    public void btnGuardarValor(ActionEvent actionEvent){
        ...
        try{
            ...
            Logger.getLogger(RenovacionVendedorBean.class.getName()).log(Level.SEVERE, null, ex);
        }            
    }   
    ...
    public void customXLSProceso(Object document) {
        ...
        String nombreVendedor = this.getAtributoSession(Constantes.VEND_NAME);                                                  
        config.configurarExcelRenovacion(document, true, nombreVendedor);
