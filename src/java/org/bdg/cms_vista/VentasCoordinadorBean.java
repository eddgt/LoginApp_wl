 ...
 */
@ManagedBean(name = "ventasCoordinadorBean")
@ViewScoped
public class VentasCoordinadorBean extends BaseSession {
    ...
    public List<Asesor> getListaAsesors() {
        return listaAsesors;
    }

    public void setListaAsesors(List<Asesor> listaAsesors) {
        this.listaAsesors = listaAsesors;
    }
