 ...
 */
@ManagedBean(name = "renovacionNuevaBean")
@ViewScoped
public class RenovacionNueva extends BaseSession {
    ...
    private boolean blnAjusteFijo;
    private boolean blnActivoTipoPlan;
    private boolean blnAjusteVenta;
    ///
    ...
    public void btnClickGuardar(){
        try{
           ...
           if(bandera){
                ...
                cstmt.setString("ad_fecposVenta", fechaFinal);
                cstmt.setFloat("ad_valposventa", Float.parseFloat(this.txtMonto));
                ...
                if(valorRetorno==0){
                     JsfUtil.addSuccessMessage(Constantes.SS_AGREGARRENOVACION);
                      vaciarCampos();
                }else{
                     JsfUtil.addSuccessMessage(Constantes.SS_AGREGARRENOVACIONFALLO);
                }                            
