...
public class Query_C {
    ...
    public String consulta_RepRenovMovil = "";
    public String consulta_RepRenovE1 = "";
    public String consulta_RepRenovENFijo = "";
    public String consulta_RepRenovFijo = "";
    public String consulta_RepRenovMovAG = "";
    public String consulta_RepRenovSopAR = "";
    public String consulta_TasaCambio = "";
    public String consulta_ActualizaTasaCambio = "";
    
    public String consulta_BitacoraOperacion = "";
    ...
    public String getConsulta_BitacoraOperacion() {
        return consulta_BitacoraOperacion;
    }

    public void setConsulta_BitacoraOperacion(String consulta_BitacoraOperacion) {
        this.consulta_BitacoraOperacion = consulta_BitacoraOperacion;
    }
    ...
    public void generarConsultaBitacoraOperacion(){
        String query = ("SELECT * FROM TBBO_BITACORA_OPERACIONES ORDER BY 1 DESC");
        this.setConsulta_BitacoraOperacion(query);
    }
    ...
    public void generar_Consulta_EjecutaProceso(String periodo, String usuario){
        String query = ("{CALL ComisionGt.PKG_TBBO_EJECUCION.EJECUTARPROCESOS( '"+periodo+"',"+ "'"+ usuario+ "')}");
...
//            + " and estado_coordinador = 'VRP'"
    ...
    public String getConsulta_RepRenovMovil() {
        return consulta_RepRenovMovil;
    }

    public void setConsulta_RepRenovMovil(String consulta_RepRenovMovil) {
        this.consulta_RepRenovMovil = consulta_RepRenovMovil;
    }

    public String getConsulta_RepRenovE1() {
        return consulta_RepRenovE1;
    }

    public void setConsulta_RepRenovE1(String consulta_RepRenovE1) {
        this.consulta_RepRenovE1 = consulta_RepRenovE1;
    }

    public String getConsulta_RepRenovENFijo() {
        return consulta_RepRenovENFijo;
    }

    public void setConsulta_RepRenovENFijo(String consulta_RepRenovENFijo) {
        this.consulta_RepRenovENFijo = consulta_RepRenovENFijo;
    }

    public String getConsulta_RepRenovFijo() {
        return consulta_RepRenovFijo;
    }

    public void setConsulta_RepRenovFijo(String consulta_RepRenovFijo) {
        this.consulta_RepRenovFijo = consulta_RepRenovFijo;
    }

    public String getConsulta_RepRenovMovAG() {
        return consulta_RepRenovMovAG;
    }

    public void setConsulta_RepRenovMovAG(String consulta_RepRenovMovAG) {
        this.consulta_RepRenovMovAG = consulta_RepRenovMovAG;
    }

    public String getConsulta_RepRenovSopAR() {
        return consulta_RepRenovSopAR;
    }

    public void setConsulta_RepRenovSopAR(String consulta_RepRenovSopAR) {
        this.consulta_RepRenovSopAR = consulta_RepRenovSopAR;
    }

    public static String getConsulta_TasaCambio(String periodo) {
        return  "SELECT TASA_CAMBIO FROM VIEW_TBBO_TASA_CAMBIO_PERIODO WHERE PERIODO = '"+periodo+"'";
        
    }

    public void setConsulta_TasaCambio(String consulta_TasaCambio) {
        this.consulta_TasaCambio = consulta_TasaCambio;
    }

    public String getConsulta_ActualizaTasaCambio(float tasaCambio, String periodo) {
        String myPackage = "{CALL COMISIONGT.PKG_TBBO_OPERACIONES.TASA_DE_CAMBIO("+tasaCambio+",'"+periodo+"')}";
        return myPackage;        
    }

    public void setConsulta_ActualizaTasaCambio(String consulta_ActualizaTasaCambio) {
        this.consulta_ActualizaTasaCambio = consulta_ActualizaTasaCambio;
    }
    

    public void generarConsultasReporteRenovaciones(String nombreReporte){
        if (nombreReporte!=null){
            if (nombreReporte == "MOVIL"){
                String consulta = new StringBuilder()
                .append("SELECT * FROM VIEW_TBBO_RENOVACIONES_MOVIL").toString();
            this.setConsulta_RepRenovMovil(consulta);
        }
            if(nombreReporte=="E1"){
                String consulta = new StringBuilder()
                .append("SELECT * FROM VIEW_TBBO_RENOVACIONES_E1").toString();
            this.setConsulta_RepRenovMovil(consulta);
            }
            if(nombreReporte=="ENFIJO"){
                String consulta = new StringBuilder()
                .append("SELECT * FROM VIEW_TBBO_RENOVACIONES_EN_FIJO").toString();
            this.setConsulta_RepRenovMovil(consulta);
            }
            if(nombreReporte=="FIJO"){
                String consulta = new StringBuilder()
                .append("SELECT * FROM VIEW_TBBO_RENOVACIONES_FIJO").toString();
            this.setConsulta_RepRenovMovil(consulta);
            }
            if(nombreReporte=="MOVAG"){
                String consulta = new StringBuilder()
                .append("SELECT * FROM VIEW_TBBO_RENOVACIONES_MOV_AG").toString();
                this.setConsulta_RepRenovMovil(consulta);
            }
            if(nombreReporte=="SOPJR"){
                String consulta = new StringBuilder()
                .append("SELECT * FROM VIEW_TBBO_RENOVACIONES_SOP_JR").toString();
                this.setConsulta_RepRenovMovil(consulta);
            }
